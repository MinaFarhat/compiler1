// Generated from C:/Users/EVO.STORE/IdeaProjects/tasneem/src/antlr\dartLexer.g4 by ANTLR 4.10.1
package antlr;
...
public class dartLexer extends Lexer {
	...
	public static final int
		...
		LineRow=136;
	public static final int
		BODY=1, BUILD=2, Dic=3, CLASS_DECLARATION=4, Constructor=5, CARDWIDGET=6, 
		ScaffoldWidget=7, GestureDetectorWidget=8, TextWidget=9, ColumnWidget=10, 
		CONTAINERWIDGET=11, RowWidget=12;
	public static String[] channelNames = {
		"DEFAULT_TOKEN_CHANNEL", "HIDDEN"
	};

	public static String[] modeNames = {
		"DEFAULT_MODE", "BODY", "BUILD", "Dic", "CLASS_DECLARATION", "Constructor", 
		"CARDWIDGET", "ScaffoldWidget", "GestureDetectorWidget", "TextWidget", 
		"ColumnWidget", "CONTAINERWIDGET", "RowWidget"
	};

	private static String[] makeRuleNames() {
		return new String[] {
			"CLASS", "IMPORT_", "TRY", "CATCH", "EQUALS", "PLUS_EQUALS", "MINUS_EQUALS", 
